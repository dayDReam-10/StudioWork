...
public interface UserService {
    ...
    List<User> getFollowingUsers(int userId) throws Exception;

    List<User> getFollowerUsers(int userId) throws Exception;
    ...
    // 验证缓存的登录信息
    User validateCachedLogin(String username, String encryptedPassword) throws Exception;
    User validateAdminCachedLogin(String username, String encryptedPassword) throws Exception;
    // 更新用户信息
    ...
    String generateEncryptedPassword(String username, String password);
}
