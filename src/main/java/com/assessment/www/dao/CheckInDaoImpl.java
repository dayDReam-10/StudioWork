...
public class CheckInDaoImpl implements CheckInDao {
    ...
    public boolean hasCheckedInToday(Integer userId) {
        // 避免时区,错误写法 string sql = "SELECT COUNT(*) FROM checkin WHERE user_id = ? AND DATE(time_create) = CURDATE()";
    ...
    @Override
    public List<CheckIn> getUserCheckIns(Integer userId, int page, int pageSize) {//降序展示用户签到记录
    ...
    @Override
    public CheckIn getUserTodayCheckIn(Integer userId) {//用户点击“签到”成功后，返回当天的签到记录
